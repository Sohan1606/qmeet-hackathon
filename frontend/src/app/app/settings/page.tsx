...
import { User, Bell, CreditCard, Shield, Users as TeamIcon, Link as LinkIcon, LogOut, Camera, Check } from "lucide-react"
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-56 border-r border-gray-100 bg-white p-2 overflow-y-auto">
          ...
          <div className="mt-4 pt-4 border-t border-gray-100">
            <button onClick={handleSignOut} className="w-full flex items-center gap-2 px-3 py-2 rounded text-[13px] font-medium text-red-600 hover:bg-red-50">
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-[#FBFBFA]">
          ...
          {activeTab === "integrations" && (
            <div className="max-w-3xl">
              ...
              <a href="/app/integrations" className="inline-flex items-center gap-2 px-4 py-2 bg-[#2383E2] text-white rounded-lg text-sm font-semibold hover:bg-[#1a6dc4]">
